...
void protobuf_AssignDesc_protocol_2fskeleton_2eproto() {
  ...
  static const int Skeleton_Joint_offsets_[8] = {
...
void protobuf_AddDesc_protocol_2fskeleton_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\030\004 \003(\0132\034.RemoteKinect.Skeleton.Joint\032\214\004\n"
